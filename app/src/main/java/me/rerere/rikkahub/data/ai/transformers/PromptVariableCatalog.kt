...
object PromptVariableCatalog {
    val all: List<PromptVariableDescriptor> = listOf(
        ...
        PromptVariableDescriptor(
            ...
            labelRes = R.string.prompt_variable_max_title_length,
            descriptionRes = R.string.prompt_variable_max_title_length_desc,
            scopes = setOf(PromptVariableScope.TITLE_PROMPT),
            syntax = PromptVariableSyntax.SINGLE_BRACES,
        ),
        PromptVariableDescriptor(
            key = "suggestion_count",
            labelRes = R.string.prompt_variable_suggestion_count,
            descriptionRes = R.string.prompt_variable_suggestion_count_desc,
            scopes = setOf(PromptVariableScope.SUGGESTION_PROMPT),
            syntax = PromptVariableSyntax.SINGLE_BRACES,
        ),
        PromptVariableDescriptor(
            key = "suggestion_max_length",
            labelRes = R.string.prompt_variable_suggestion_max_length,
            descriptionRes = R.string.prompt_variable_suggestion_max_length_desc,
            scopes = setOf(PromptVariableScope.SUGGESTION_PROMPT),
            syntax = PromptVariableSyntax.SINGLE_BRACES,
        ),
        PromptVariableDescriptor(
            key = "suggestion_style",
            labelRes = R.string.prompt_variable_suggestion_style,
            descriptionRes = R.string.prompt_variable_suggestion_style_desc,
            scopes = setOf(PromptVariableScope.SUGGESTION_PROMPT),
            syntax = PromptVariableSyntax.SINGLE_BRACES,
        ),
        PromptVariableDescriptor(
