...
import me.rerere.rikkahub.ui.pages.setting.components.CustomProviderEditor
    ...
    Column(
        ...
        Row(
            ...
            ProviderConnectionTester(
                ...
                onApplyDetectedCapabilities = {
                    internalProvider = internalProvider.editModel(it)
                },
            )
                ...
                0 -> {
                    ...
                    Column(
                        ...
                        if (model.type == ModelType.CHAT) {
                            OutlinedTextField(
                                value = formatContextWindowTokens(model.contextWindowTokens),
                                onValueChange = { value ->
                                    if (value.isEmpty() || parseContextWindowTokens(value) != null) {
                                        onModelChange(
                                            model.copy(
                                                contextWindowTokens = parseContextWindowTokens(value),
                                            )
                                        )
                                    }
                                },
                                ...
                                supportingText = {
                                    Text(stringResource(R.string.setting_provider_page_context_window_desc))
                                },
