...
class WebServerService : Service() {
    ...
    companion object {
        const val ACTION_START = "me.rerere.rikkahub.revised.action.WEB_SERVER_START"
        const val ACTION_STOP = "me.rerere.rikkahub.revised.action.WEB_SERVER_STOP"
    ...
    private fun startForegroundCompat(): Boolean {
        return try {
            ...
            webServerManager.reportError(e)
            false
        }
    }
